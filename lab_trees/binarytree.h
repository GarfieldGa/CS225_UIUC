...
class BinaryTree
{
    public:
        ...
        void isOrdered(Node* &r, Node* & tmp, bool & b) const;
        ...
        void getPath(std::vector<std::vector<T>>& paths, std::vector<T> path, Node* node) const;
        ...
        int sumDistances(Node* node, int count) const;
